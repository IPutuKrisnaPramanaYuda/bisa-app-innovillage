...
>
    <div class="p-6 flex items-center justify-between border-b border-white/10">
        <div class="flex items-center gap-3">
            ...
            <div class="leading-tight">
                <h1 class="text-xl font-bold tracking-wide">BISA</h1>
                <p class="text-[10px] text-blue-200 opacity-80">Bengkala Interactive Smart Assistant</p>
            </div>
        </div>
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto flex flex-col">
        ...
        <div class="pt-4 mt-2 border-t border-white/10">
            <a href="{{ route('landing') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-yellow-300 hover:bg-white/10 hover:text-yellow-200 transition duration-200">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
